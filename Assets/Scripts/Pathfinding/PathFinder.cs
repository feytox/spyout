...
public static class PathFinder
{
    ...
    public static IEnumerable<Vector3Int> FindAStarPath(
        GameObject walker,
        TileGrid grid,
        Vector3Int start,
        Vector3Int end
    ...
    private static void ProcessNeighbours(
        GameObject walker,
        Vector3Int current,
        int currentCost,
        Vector3Int start,
        PriorityQueue<Vector3Int, int> frontier,
        TileGrid grid,
        Dictionary<Vector3Int, PointData> track
    )
    {
