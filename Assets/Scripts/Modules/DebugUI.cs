...
public class DebugUI : MonoBehaviour
{
    ...
    private bool _extraInfoChanged = false;
    ...
    public static void SetExtraInfo(string key, string value)
    {
        var instance = GetInstance();
        instance._extraInfo[key] = value;
    ...
    void Awake()
    {
        ...
        // Simple config check
        Debug.Assert(BufferDuration > 0f, "BufferDuration must be > 0");
    }
    ...
    private void UpdateInfo(bool isFpsUpdated)
    {
        ...
        var text = new StringBuilder(27); // optimal capacity for no extra info
